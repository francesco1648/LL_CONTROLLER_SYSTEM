#line 1 "C:\\Users\\franc\\Desktop\\isaac\\def_CAN_TX_RX\\can_exchange\\lib\\Can\\src\\CanWrapper.cpp"
...
bool CanWrapper::readMessage(uint8_t* ID_MODULE, uint8_t* CAN_OTHER_FLAG  , uint8_t* id, byte* data) {
    struct can_frame msg = {0};
    if (mcp2515.readMessage(&msg) == MCP2515::ERROR_OK) {
        *id = ( msg.can_id >> 16 ) & 0xFF;
         *CAN_OTHER_FLAG = ( msg.can_id >> 8 ) & 0xFF;
         *ID_MODULE = ( msg.can_id ) & 0xFF;
