#line 1 "C:\\Users\\franc\\Desktop\\isaac\\def_CAN_TX_RX\\can_exchange\\lib\\Can\\src\\CanWrapper.h"
...
public:
     ...
     */
    bool readMessage(uint8_t* ID_MODULE, uint8_t* CAN_OTHER_FLAG  ,uint8_t* id, byte* data);
